...
int main()
{
    ...
    while (window.pollEvent(event))
    {
		...
		printf("X:%f Y:%f X:%i Y:%i, solid:%i item:%i itemId:%i playerit:%i items:%i iid:%i portal:%i \n"
		,aPos.x,aPos.y,pzz.x,pzz.y, sol, 
		isit, itemId, imgr.playerItemCount(), map.itemsOnMapCount(),iid,por);
